            ...
            <CardContent className="p-6 space-y-5">
              <div className="flex gap-4">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-semibold text-lg">{['CONCERT','SPORTS','THEATRE','FESTIVAL','SHOW'].includes(scheduleData.transportMode) ? scheduleData.originCity : `${scheduleData.originCity} \u2192 ${scheduleData.destinationCity}`}</h3>
